            ...
            <Row>
                <Col md={6}>
                    ...
                    <span className="price-span">
                        ...
                        <button className="btn btn-danger quantity-minus-btn" onClick={handleMinusClick}>-</button>
                        <input type="text" value={quantityCount} className="quantity-input"/>
                        <button className="btn btn-success quantity-plus-btn" onClick={handlePlusClick}>+</button>
                    </span>
                    <br/><br/><br/>
                    {/* {console.log(item) } */}
                    <Button className="my-btn" variant="outline-danger" onClick={()=>props.addToCart({ ...props.food, price: currentItemTotalPrice, quantity: quantityCount})}><FontAwesomeIcon icon={faCartPlus} /> Add</Button>
                </Col>
